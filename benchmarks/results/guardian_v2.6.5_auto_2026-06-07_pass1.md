...
**Version:** 2.6.5
**Tier:** auto
**Generated:** 2026-06-07 03:50 UTC
...
| ROC-AUC | **0.800** | — | — |
| p50 Latency | **3862.0ms** | ~51ms | +3811.0ms |
| p99 Latency | **8434.5ms** | N/A | — |
...
|:---|:---|---:|---:|---:|---:|---:|:---|
| **Guardian v2.6.5 (auto)** | no-context | **0.967** | **0.995** | **0.981** | **0.035** | **3862.0ms** | *this report* |
...
- **Evaluation date:** 2026-06-07 03:50 UTC
