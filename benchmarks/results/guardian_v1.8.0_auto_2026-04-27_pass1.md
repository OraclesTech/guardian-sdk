...
**Version:** 1.8.0
**Tier:** auto
**Generated:** 2026-04-27 22:43 UTC
...
| ROC-AUC | **0.672** | — | — |
| p50 Latency | **739.2ms** | ~51ms | +688.2ms |
| p99 Latency | **988.5ms** | N/A | — |
...
|:---|:---|---:|---:|---:|---:|---:|:---|
| **Guardian v1.8.0 (auto)** | no-context | **0.000** | **0.000** | **0.000** | **0.001** | **739.2ms** | *this report* |
...
- **Evaluation date:** 2026-04-27 22:43 UTC
